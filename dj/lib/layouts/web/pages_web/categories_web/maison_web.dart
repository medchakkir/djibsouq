...
class MaisonCategoryWeb extends StatefulWidget {
  const MaisonCategoryWeb({super.key});

  @override
  State<MaisonCategoryWeb> createState() => _MaisonCategoryWebState();
}

class _MaisonCategoryWebState extends State<MaisonCategoryWeb> {
  ...
  void initState() {
    super.initState();
    products = ProductRepository.getProductsByCategory("Maison");
  }
