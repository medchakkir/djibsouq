...
class SportsCategoryWeb extends StatefulWidget {
  ...
  @override
  State<SportsCategoryWeb> createState() => _SportsCategoryWebState();
}

class _SportsCategoryWebState extends State<SportsCategoryWeb> {
  ...
  void initState() {
    super.initState();
    products = ProductRepository.getProductsByCategory("Sports");
  }
