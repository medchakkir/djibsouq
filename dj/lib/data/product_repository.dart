...
class ProductRepository {
  ...
  static List<Product> products = [
    Product(id: 1, title: "iPhone 15 Pro", price: 999.99, image: "📱", category: "New Arrivals", description: "Latest iPhone with amazing features", rating: 4.8, reviews: 256, isBestSeller: true),
    Product(id: 2, title: "Samsung Galaxy Buds", price: 149.99, image: "🎧", category: "New Arrivals", description: "Premium wireless earbuds", rating: 4.6, reviews: 128, isBestSeller: true),
    Product(id: 3, title: "Laptop ASUS", price: 1299.99, image: "💻", category: "New Arrivals", description: "Powerful laptop for work and gaming", rating: 4.7, reviews: 89, isBestSeller: true),
    Product(id: 4, title: "iPad Air", price: 599.99, image: "📱", category: "New Arrivals", description: "Perfect tablet for creativity", rating: 4.9, reviews: 342, isBestSeller: true),
    Product(id: 5, title: "T-Shirt Nike", price: 49.99, image: "👕", category: "New Arrivals", description: "Comfortable cotton T-shirt", rating: 4.5, reviews: 512, isBestSeller: true),
    Product(id: 6, title: "Jeans Levi's", price: 79.99, image: "👖", category: "New Arrivals", description: "Classic denim jeans", rating: 4.6, reviews: 321, isBestSeller: true),
    Product(id: 7, title: "Veste Adidas", price: 129.99, image: "🧥", category: "New Arrivals", description: "Stylish sports jacket", rating: 4.4, reviews: 198, isBestSeller: true),
    Product(id: 8, title: "Chaussures Puma", price: 99.99, image: "👟", category: "New Arrivals", description: "Professional running shoes", rating: 4.7, reviews: 267, isBestSeller: true),
    Product(id: 9, title: "Lampe LED", price: 39.99, image: "💡", category: "New Arrivals", description: "Modern LED lighting solution", rating: 4.6, reviews: 145, isBestSeller: true),
    Product(id: 10, title: "Canapé Moderne", price: 599.99, image: "🛋️", category: "New Arrivals", description: "Comfortable modern sofa", rating: 4.8, reviews: 87, isBestSeller: true),
    Product(id: 11, title: "Tapis Persan", price: 199.99, image: "🧶", category: "New Arrivals", description: "Traditional Persian carpet", rating: 4.5, reviews: 63, isBestSeller: true),
    Product(id: 12, title: "Tableau Déco", price: 89.99, image: "🖼️", category: "New Arrivals", description: "Decorative wall painting", rating: 4.4, reviews: 112, isBestSeller: true),
    Product(id: 13, title: "Ballon de Foot", price: 59.99, image: "⚽", category: "New Arrivals", description: "Professional football", rating: 4.7, reviews: 234, isBestSeller: true),
    Product(id: 14, title: "Raquette Tennis", price: 149.99, image: "🎾", category: "New Arrivals", description: "High-performance tennis racket", rating: 4.6, reviews: 89, isBestSeller: true),
    Product(id: 15, title: "Haltères", price: 299.99, image: "🏋️", category: "New Arrivals", description: "Adjustable dumbbells set", rating: 4.8, reviews: 156, isBestSeller: true),
    Product(id: 16, title: "Tapis Yoga", price: 39.99, image: "🧘", category: "Sports", description: "Premium yoga mat", rating: 4.5, reviews: 203),
